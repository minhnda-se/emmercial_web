...
const Home = () => {
  ...
  useEffect(() => {
    const user = { email: "user1@gmail.com", password: "1234", name: "user1" };
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <div className="flex flex-col justify-between fixed bottom-2 right-2 rounded-lg p-4 w-20 h-30 z-50">
